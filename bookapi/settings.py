...
SECRET_KEY = 'django-insecure-o)a7ccfu%kkxwoeuosa98s)bv4_0%h(n2&xxkt(fx!b=9+#irh'
...
# Solution 1 (Recommandée) - Avec valeur par défaut
DATABASES = {
    'default': dj_database_url.config(
        default='sqlite:///db.sqlite3',  # Fallback pour développement
        conn_max_age=600,
        ssl_require=True
    )
}
